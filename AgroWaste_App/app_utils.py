...
# --- Función generate_report_with_shap (corregida) ---
def generate_report_with_shap(data, frap_value, beeswarm_img, waterfall_img, recommendations=None):
    ...
    try:
        ...
        <body>
            ...
            <img src="image/png;base64,{waterfall_b64}" alt="SHAP Waterfall">
...
# --- Función generate_batch_report_with_shap (corregida) ---
            ...
            <div style="page-break-before: always;">
                <div style="display: flex; justify-content: space-between;">
                    <div style="width: 48%; margin-right: 2%;">
                        ...
                        <div style="text-align: center;">
                            <img src="image/png;base64,{img_to_base64(img_path_1)}" alt="SHAP Waterfall" style="max-width: 95%; height: auto;">
                        </div>
